...
const nameCheck = (name) => {
  if (name === 'Steven') {
    ...
    console.log(`Cool name, ${name.toUpperCase()}.`)
  }
}

let nameGreeting = nameCheck('Katryna')
...
function faveColorFinder(color) {
  if (color === 'red') {
    ...
    return 'you need to evaluate your color of choice'
  }
}
...
function theEliminator(participants, losers) {
  let newContestants = [];
  for (let i = 0; i < participants.length; i++) {
    if (participants[i] === losers) {
...
console.log(emailCheck('Katryna@gmail.com'))
...
function chocolateFrogMachine(gold) {
  return Math.floor(gold / 3)
}

let totalFrogs = chocolateFrogMachine(10);
...
/*
  ...
  If you were to pass in 4 gold, the function would return to you 1.3333... However, you can't really go to a store and by 1.333 products. You would just be able to purchase 1 product. Re-write the function you used in the previous problem (give it the same name, just add a 2 to the end of it) that fixes this bug. Invoke the function and store the returned value to a variable called `totalFrogs2`.
*/
...
let arrayIsAscending = ascendingTest(sampleArray)
